...
namespace tubex
{
   ...
   */
    ...
    std::vector<ibex::IntervalVector> capd2ibex(const ibex::Interval& domain, capd::IMap& vectorField, const ibex::IntervalVector& x0, std::vector<ibex::IntervalVector>& gates  ,std::vector<double> & gatetimes , const double& timestep=0);
